        ...
        <>
          ...
          >
            <Card className="w-full bg-customMain border-neutral-800 text-white max-w-md mx-auto">
              <CardHeader>
                <CardTitle className="text-center w-full">Profile</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex flex-col items-center space-y-4">
                  <Avatar className="h-24 w-24">
                    <AvatarImage src={""} alt={auth.user?.username} />
                    <AvatarFallback className="bg-gradient-to-r from-purple-400 to-pink-500 text-3xl font-bold">
              ...
              <CardFooter className="flex gap-2 justify-end">
                ...
                {!showPasswordChange && (
                  <Button
                    className="font-semibold bg-red-900 hover:bg-red-700 rounded-lg"
                    variant="axon"
